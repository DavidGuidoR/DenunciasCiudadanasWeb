...
// Visualizar el contenido de $msg
var_dump($msg);
...
<body>
     ...
     <div class="out">
          ...
          if ($flag == 0) {
               ...
               $output = "Sorry I have no knowledge of " . $msgg . " yet. Type only one keyword without space instead of full sentence. For Emergency Help Call: 01757687942 Or http://iso.ac.bd";
               $result = make_links_clickable($output);
               echo "$result";
          }
