      ...
      <div class="col-sm-7">
        ...
        <div class="chat">
          <a style="text-decoration:none;" href="#">
            <div id="sc">
              <center><img style="float:left;" src="img/ruet.png" width="20px" height="20px" /><b>Chat</b></center>
            </div>
          </a>
          <div id="panel">
            ...
            <script>
              $(document).ready(function() {
                ...
                $("#sc").click(function() {
                  ...
                  if (i == 1) {
                    $('#div').html("<div class=\"ou\"> Hola, Bienvenido. <br> ¿En qué puedo apoyarte?</div><br>");
